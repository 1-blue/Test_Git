...
int main(void)
{
	...
	GameManager gameManager(commonData);
	gameManager.InitBoard();
	EffectManager* effectManager = new EffectManager(commonData);
	MenuUI menuUI(commonData);
	GameUI gameUI(commonData);
	GameOverUI gameoverUI(commonData);
	Enemy enemy(commonData, effectManager);
	UfoEnemy ufo(commonData, effectManager);
	Player player(commonData);
